...
encoded_username = urllib.parse.quote_plus("mohandhoundiyal007")
encoded_password = urllib.parse.quote_plus("mOH@N15082003")

# Reconstruct the connection string with encoded credentials
connection_string = f"mongodb+srv://{encoded_username}:{encoded_password}@cluster0.bqkwn5k.mongodb.net/test?retryWrites=true&w=majority&authSource=admin"
